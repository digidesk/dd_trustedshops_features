        ...
        [{if count( $aLanguages )}]
            ...
            <div class="row">
                ...
                <div class="dd-register-btn text-center">
                    <a href="https://business.trustedshops.de/shopsoftware/oxid?&a_aid=Oxid" class="btn btn-primary text-center" target="_blank">[{oxmultilang ident="DD_TRUSTEDSHOPS_FEATURES_REGISTER"}]</a>
                </div>
            </div>
