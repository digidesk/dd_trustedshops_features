...
($oTSID->savedTab == 'expert' && $oTSID->collect_product_reviews_expert == '1' && ($oTSID->collect_product_reviews_details_tab_expert || $oTSID->collect_product_reviews_details_star_expert))}]
    ...
    [{assign var="oTopView" value=$oConfig->getTopActiveView()}]
    [{include file="widget/dd_trustedshops_features_widget.tpl" sFeature="product_sticker" oArticle=$oTopView->getProduct()}]
[{/if}]
