...
[{oxstyle include=$oViewConf->getModuleUrl('digidesk','dd_trustedshops_features/out/src/css/backend.min.css')}]
...
[{oxstyle  include=$oViewConf->getModuleUrl('digidesk','dd_trustedshops_features/out/src/css/backend.min.css')}]
[{oxscript include=$oViewConf->getModuleUrl('digidesk','dd_trustedshops_features/out/src/js/backend.min.js') priority=10}]
