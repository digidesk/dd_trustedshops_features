...
$aLang = array(
    ...
    'DD_TRUSTED_SHOPS_INTEGRATION_SETTINGS'        => 'Paramètres',
    'DD_TRUSTEDSHOPS_FEATURES_MODAL_LOADING'       => 'Chargement...',
    ...
    // Errors
    'DD_TRUSTEDSHOPS_FEATURES_ERRORS_EMPTY_TSID'   => "S'il vous plaît entrez votre Trusted Shops ID.",

    // Alerts
    'DD_TRUSTEDSHOPS_FEATURES_ALERTS_SAVE_SUCCESS' => 'Paramètres sauvegardés.',
    ...
    // Standard-View
    'DD_TRUSTEDSHOPS_FEATURES_TRUSTBADGE_TITLE'                                    => 'Trustbadge',
    ...
    'DD_TRUSTEDSHOPS_FEATURES_STANDARD_VARIANT_1'                                  => 'Standard',
    'DD_TRUSTEDSHOPS_FEATURES_STANDARD_VARIANT_2'                                  => 'Reviews',
    ...
    'DD_TRUSTEDSHOPS_FEATURES_STANDARD_TOP_OFFSET_INFO'                            => 'Move the Trustbadge up to 250 pixels up (only for Standard and Reviews)',
    'DD_TRUSTEDSHOPS_FEATURES_CUSTOMER_REVIEWS_TITLE'                              => 'Configure Customer Reviews',
    'DD_TRUSTEDSHOPS_FEATURES_CUSTOMER_REVIEWS_REVIEW_STICKER_POSITION'            => 'Activate Review Sticker',
    'DD_TRUSTEDSHOPS_FEATURES_CUSTOMER_REVIEWS_REVIEW_STICKER_POSITION_0'          => 'Deactivate',
    'DD_TRUSTEDSHOPS_FEATURES_CUSTOMER_REVIEWS_REVIEW_STICKER_POSITION_1'          => 'Footer (horizontal)',
    'DD_TRUSTEDSHOPS_FEATURES_CUSTOMER_REVIEWS_REVIEW_STICKER_POSITION_2'          => 'Sidebar (vertical)',
    ...
    'DD_TRUSTEDSHOPS_FEATURES_CUSTOMER_REVIEWS_GOOGLE_RICH_SNIPPETS_INFO_TEXT'     => 'Rich Snippets ensure that your ratings will appear in search results in Google. Select where you want to enable Rich Snippets:',
    ...
    'DD_TRUSTEDSHOPS_FEATURES_PRODUCT_STICKER_TITLE'                               => 'Product ratings',
